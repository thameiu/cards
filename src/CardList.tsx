...
const CARD_DEFINITIONS: CardDefinition[] = [
  ...
  { id: "sebastienallart", label: "Sebastien Allart", description: "my favorite modern painter, located in aix-en-provence. i've been a fan of his work since i was a child." },
