...
const CARD_DEFINITIONS: CardDefinition[] = [
  ...
  { id: "artsenikcreations", label: "Art'senik Creations", description: "creative handcrafted jewerly made from mechanic scraps.", tags: ["fashion","craftsmanship","art"] },
  { id: "artikodinex", label: "Artikodin EX", description: "articuno ex pokemon tcg card. probably my rarest pokemon card", tags: ["miscellaneous"] },
  { id: "blackmoonbotanica", label: "Black Moon Botanica", description: "very cool witchcraft shop in edinburgh.", tags: ["shop"] },
  { id: "blowup", label: "Blow-Up", description: "vintage store in aix-en-provence.", tags: ["shop","fashion"] },
  ...
  { id: "gnocchidelanonna", label: "Gnocchi de la Nonna", description: "gnocchi restaurant in aix-en-provence.", tags: ["food"] },
  ...
  { id: "keshcraft", label: "Keshcraft", description: "artisanal lamp shop in marrakech's souk.", tags: ["craftsmanship","shop"] },
  ...
  { id: "lecesar", label: "Le César", description: "seafood (mostly) restaurant in sausset-les-pins.", tags: ["food"] },
  { id: "lelocal", label: "Le Local", description: "very good corsican restaurant in bouc-bel-air.", tags: ["food"] },
  { id: "lequatre", label: "Le Quatre", description: "amazing semi-gourmet restaurant in aix-en-provence, now unfortunately closed.", tags: ["food"] },
  ...
  { id: "mancardi", label: "Mancardi²", description: "sculptor located in la roque d'anthéron.", tags: ["art","craftsmanship"] },
  ...
  { id: "seito", label: "Seito", description: "korean bbq restaurant in aix-en-provence.", tags: ["food"] },
    { id: "splelegante", label: "SP L'Elegante", description: "french artisanal jewerly brand.", tags: ["fashion","craftsmanship"] },
